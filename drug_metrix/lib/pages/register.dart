  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.green, // Green color for the AppBar background.
      ),
      
      // The body of the page is wrapped in Padding for spacing.
      body: Padding(
        padding: const EdgeInsets.all(18.0), // Padding adds space (16 pixels) around the content.
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              // Styling the button: Background color is green and text color is black.
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.green, // Teal button background.
